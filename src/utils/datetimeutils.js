...
export {
    getNowTimestamp, isExpire,
    timestamp2Date, timestamp2DateStr,
    getTimestampByDate, getDateStrByDate,
    timestampPlusSecond, timestampPlusMinute,
    dateStrPlusMinute, dateStrPlusSecond
}