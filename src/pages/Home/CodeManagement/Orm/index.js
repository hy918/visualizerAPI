...
const RomTable = (props) => {
  ...
  const handleDel = async () => {
    try {
      // console.log("处理删除", optionId)
      const res = await ormService.ormCodeDelete(optionId);
      if (res?.code === 10200) {
  ...
  return (
    <div className="ormTableList">
      ...
      <Details id={optionId} visible={detailVisible} editVisible={detailVisible}
